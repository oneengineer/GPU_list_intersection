...
extern int _Z14next_queue_posi(int);
# 12 "../src/indices/cal_indices.cu"
extern void _Z10cal_indx_1iii(int, int, int);
# 59 "../src/indices/cal_indices.cu"
extern void _Z13bitonic_mergebPViii(__nv_bool, volatile int *, int, int);
# 119 "../src/indices/cal_indices.cu"
extern __nv_bool _Z14monotone_checkPii(int *, int);
# 126 "../src/indices/cal_indices.cu"
extern void _Z10cal_indx_2iiii(int, int, int, int);
# 249 "../src/indices/cal_indices.cu"
extern void _Z10cal_indx_3ii(int, int);
# 411 "../src/indices/cal_indices.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z8cal_indxiii(int, int, int);
# 421 "../src/indices/cal_indices.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z12move_indicesiiii(int, int, int, int);
# 63 "../src/indices/../common_defines.h"
extern __attribute__((device)) __attribute__((__used__)) int *list_p0[2];
# 64 "../src/indices/../common_defines.h"
extern __attribute__((device)) __attribute__((__used__)) int *list_p[4][2];
# 65 "../src/indices/../common_defines.h"
extern __attribute__((device)) __attribute__((__used__)) int calculated_indices_len[4][4];
# 66 "../src/indices/../common_defines.h"
extern __attribute__((device)) __attribute__((__used__)) int swapped[4];
# 67 "../src/indices/../common_defines.h"
extern __attribute__((device)) __attribute__((__used__)) int *_result;
# 68 "../src/indices/../common_defines.h"
extern __attribute__((device)) __attribute__((__used__)) int gpu_result_size;
# 69 "../src/indices/../common_defines.h"
extern __attribute__((device)) __attribute__((__used__)) int _nm[2];
# 70 "../src/indices/../common_defines.h"
extern __attribute__((device)) __attribute__((__used__)) struct partition_info partitions_info[4][2052];
# 71 "../src/indices/../common_defines.h"
extern __attribute__((device)) __attribute__((__used__)) int *_result_addr[4];
# 73 "../src/indices/../common_defines.h"
extern __attribute__((device)) __attribute__((__used__)) int o_scan_buffers[4][2116];
# 74 "../src/indices/../common_defines.h"
extern __attribute__((device)) __attribute__((__used__)) int *_scan_buffers[4];
# 83 "../src/indices/../common_defines.h"
extern __attribute__((device)) __attribute__((__used__)) struct debug_structure debug1;
...
# 85 "../src/indices/../common_defines.h" 2
# 7 "../src/indices/cal_indices.cu"
 int _Z14next_queue_posi(
# 7 "../src/indices/cal_indices.cu"
int value){
# 7 "../src/indices/cal_indices.cu"
{
...
# 119 "../src/indices/cal_indices.cu"
 __nv_bool _Z14monotone_checkPii(
# 119 "../src/indices/cal_indices.cu"
int *list,
# 119 "../src/indices/cal_indices.cu"
int n){
...
static __attribute__((shared)) __attribute__((__used__)) volatile int __cuda_local_var_34762_40_non_const_shared[2][2049];
# 174 "../src/indices/cal_indices.cu"
 int __cuda_local_var_34771_7_non_const_whole_id;
# 175 "../src/indices/cal_indices.cu"
static __attribute__((shared)) __attribute__((__used__)) volatile int __cuda_local_var_34772_40_non_const_shared_decide_next_addr[2049];
...
static __attribute__((shared)) __attribute__((__used__)) volatile int __cuda_local_var_34891_40_non_const_shared[2][2049];
# 295 "../src/indices/cal_indices.cu"
 int __cuda_local_var_34892_7_non_const_whole_id;
# 304 "../src/indices/cal_indices.cu"
static __attribute__((shared)) __attribute__((__used__)) volatile int __cuda_local_var_34901_40_non_const_shared_decide_next_addr[2049];
...
# 411 "../src/indices/cal_indices.cu"
__attribute__((global)) __attribute__((__used__)) void _Z8cal_indxiii(
# 411 "../src/indices/cal_indices.cu"
int block_size,
# 411 "../src/indices/cal_indices.cu"
int block_2_size,
...
# 421 "../src/indices/cal_indices.cu"
__attribute__((global)) __attribute__((__used__)) void _Z12move_indicesiiii(
# 421 "../src/indices/cal_indices.cu"
int __val_paramlen1,
# 421 "../src/indices/cal_indices.cu"
int __val_paramlen2,
...
int block_size,
# 421 "../src/indices/cal_indices.cu"
int indices_now){int len1 = __val_paramlen1;int len2 = __val_paramlen2;
# 421 "../src/indices/cal_indices.cu"
{
# 421 "../src/indices/cal_indices.cu"
;
