...
# 56 "../src/indices/../common_defines.h"
struct partition_info {
int *addr; int *opposite_addr;
int len; int len_opposite; int warp_len;
int left; int right;
char B2A;char __nv_no_debug_dummy_end_padding_0[3];};
# 77 "../src/indices/../common_defines.h"
struct debug_structure {
int num_loop;
int wrong_1;
...
static void __sti___19_cal_indices_cpp1_ii_2e93a852(void) __attribute__((__constructor__));
static void __sti___19_cal_indices_cpp1_ii_2e93a852(void) {   }

#include "cal_indices.cudafe1.stub.c"
